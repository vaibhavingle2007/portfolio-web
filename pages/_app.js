...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio Website of Vaibhav Ingle";
	const description =
		"Hello! I'm Vaibhav Ingle, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
	...
	return (
		<>
			<Head>
				...
				<meta name="twitter:creator" content="@vaibhav_ingle" />
