      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-left">
            <div className="footer-logo">Vaibhav Ingle</div>
          ...
          <div className="footer-right">
            ...
            <div className="footer-social">
              <a href="https://github.com/vaibhavingle2007" target="_blank" rel="noopener noreferrer" className="footer-social-link">
              ...
              <a href="https://instagram.com/ninjavex_" target="_blank" rel="noopener noreferrer" className="footer-social-link">
        ...
        <div className="footer-bottom">
          <p>&copy; 2024 Vaibhav Ingle. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
