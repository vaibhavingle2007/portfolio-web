...
export default function Navigation() {
  ...
  return (
    <nav className={isMounted && isScrolled ? 'nav visible' : 'nav'}>
      <div className="nav-container">
        <Link href="#" className="nav-logo">
          <Image src="/assets/logo.svg" alt="Vaibhav Ingle" width={92} height={42} />
        </Link>
        <div className={`nav-menu ${isMounted && isMenuOpen ? 'active' : ''}`} id="nav-menu">
        ...
        <div 
          className={`nav-toggle ${isMounted && isMenuOpen ? 'active' : ''}`} 
          id="nav-toggle"
